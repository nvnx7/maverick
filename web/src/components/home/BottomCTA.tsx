    ...
    >
      ...
      >
        ...
        <Text color="#A1A1AA" maxW="540px" mb={10} fontSize="17px">
          Whether you need millions of verified captures or want to earn by
          sourcing data, Maverick powers trustless execution on Arc.
        </Text>

        <HStack gap={4} mb={12} flexWrap="wrap" justify="center">
          <Button asChild variant="dark" px={8} py={7} fontSize="md">
