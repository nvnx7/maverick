      ...
      <SimpleGrid columns={{ base: 1, md: 2 }} gap={8}>
        ...
        >
          ...
          <Box position="relative" zIndex={1}>
            ...
            <Text textStyle="body-lg" color="fg.muted" mb={8} fontSize="16px">
              Tap into a global network of contributors ready to capture, label,
              and verify high-quality datasets under programmable smart escrow.
            </Text>
            ...
            <Button asChild variant="primary" px={6} py={6} fontSize="sm">
        ...
        >
          ...
          <Box position="relative" zIndex={1}>
            ...
            <Text textStyle="body-lg" color="fg.muted" mb={8} fontSize="16px">
              Contribute to open AI development and receive instant, transparent
              USDC payouts directly to your wallet upon verification.
            </Text>
            ...
            <Button asChild variant="outline" px={6} py={6} fontSize="sm">
